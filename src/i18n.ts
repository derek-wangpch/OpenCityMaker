...
const en = {
  ...
  undo: "Undo",
  undoHint:
    "Undo your last move once. Your personal best and discoveries stay.",
  restart: "New city",
  ...
  rotateBoardCounterclockwise: "Rotate board counterclockwise 45°",
...
const cn: Messages = {
  ...
  best: "个人最佳",
  undo: "撤销",
  undoHint: "可撤销上一步操作一次，最高分和已发现的建筑会保留。",
  restart: "新建城市",
  next: "下一个新发现",
  ...
  rotateBoardCounterclockwise: "逆时针旋转棋盘 45°",
  journey: "通往2048之旅",
  start: "一座城市，从小屋开始。",
...
const tw: Messages = {
  ...
  best: "個人最佳",
  undo: "復原",
  undoHint: "可復原上一步操作一次，最高分和已發現的建築會保留。",
  restart: "新建城市",
  next: "下一個新發現",
  ...
  rotateBoardCounterclockwise: "逆時針旋轉棋盤 45°",
  start: "一座城市，從小屋開始。",
